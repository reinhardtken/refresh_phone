...
#########################################################
  def GenInstallApkResponse(self, target=None, command=None, error=consts.ERROR_CODE_OK, serial_number=None, stage=None,
    ...
    return device.callback.GenInstallApkResponse(self.current_installapk_response, target=target, command=command, error=error, serial_number=serial_number, stage=stage,
  ...
  def ProcessScanDevices(self, command):
    def Callback(data):
      ...
      device.callback.SendDevicesList(self.queue_master, command, consts.ERROR_CODE_OK, data)
  ...
  def BeforeCommand(self, command):
    ...
    if command.cmd == consts.COMMAND_INSTALL_APK:
      ...
      device.callback.SendInstallApkResponse(self.GenInstallApkResponse(error=consts.ERROR_CODE_OK))
      pass
  ...
  def ProcessInstallApk(self, command):
    try:
      ...
      cb = device.callback.CallbackInstallObject(self)
      ...
      device.callback.SendInstallApkResponse(self.GenInstallApkResponse(error=consts.ERROR_CODE_OK, stage='开始'))
  ...
  def ProcessUninstallApk(self, command):
    try:
      ...
      cb = device.callback.CallbackUninstallObject(self)
