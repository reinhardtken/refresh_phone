...
void RefreshView::CreateExampleView(View* container) {
  ...
  ////=============================
  //index++;
  //play_sound_login_ = new TextButton(this, L" µÇÂ¼ÉùÒô");
  //play_sound_login_->set_alignment(TextButton::ALIGN_CENTER);

  //play_sound_logout_ = new TextButton(this, L" µÇ³öÉùÒô");
  //play_sound_logout_->set_alignment(TextButton::ALIGN_CENTER);

  //play_sound_order_ = new TextButton(this, L" ÏÂµ¥ÉùÒô");
  //play_sound_order_->set_alignment(TextButton::ALIGN_CENTER);

  //play_sound_withdraw_ = new TextButton(this, L" ³·µ¥ÉùÒô");
  //play_sound_withdraw_->set_alignment(TextButton::ALIGN_CENTER);

  //play_sound_clinch_ = new TextButton(this, L" ³É½»ÉùÒô");
  ...
  reconnect_ = new TextButton(this, L" Ò»¼üÁ¬½Ó");
  ...
  //=====================================================
  index++;
  refresh_ = new TextButton(this, L" Ò»¼üË¢»ú");
  ...
  //calc_password_ = new TextButton(this, L" ¼ÆËãÃÜÂë");
