...
class MarginRateTable : public CTPViewBase,
 ...
 public:
  ...
  MarginRateTable(CTPTabbedPane *p, std::string const &);
  virtual ~MarginRateTable();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MarginRateTable);
};
