...
namespace prefs {
  ...
  PHONE_COMMON_EXPORT extern const char kDebugMode[];
...
namespace command {
  ...
  PHONE_COMMON_EXPORT extern const char kPyAdbInstallApk[];
  ...
  PHONE_COMMON_EXPORT extern const char kPyAdbAutoInstall[];
