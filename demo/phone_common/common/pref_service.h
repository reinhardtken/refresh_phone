...
#ifndef CTP_PREFS_PREF_SERVICE_H_
#define CTP_PREFS_PREF_SERVICE_H_
...
class PHONE_COMMON_EXPORT PrefService : public PrefServiceBase, public base::NonThreadSafe {
 public:
