...
#include "phone_common/system_monitor/volume_mount_watcher_win.h"
...
#include "phone_common/system_monitor/media_device_notifications_utils.h"
...
void VolumeMountWatcherWin::OnWindowMessage(UINT event_type, LPARAM data) {
  ...
  ThreadMessageDispatcherImpl::DispatchHelper(CommonThread::CTP, new U2L_DeviceChange(0));
  //收到的event_type值不对，不知道什么鬼
  /*switch (event_type) {
